            ...
            <div class="col-lg-12 col-md-12">
                <table style="width:100%" >
                    ...
                    <tr v-for="(research,index) in the_research.slice().reverse().slice((page*data_in_page),(page+1)*data_in_page)" :key="index" >
                        ...
                        <td> <button class="form-control btn-primary" @click="seeResearch(research.r_id)"> See This </button> </td>
                    </tr>
                </table>
            </div>
        </div>
...
export default {
    ...
    methods:{
        ...
        seeResearch(thisresearch){
            this.$router.push({name:'research',params:{ResearchID:thisresearch}});
        },
    },
    computed:{
        the_research(){
