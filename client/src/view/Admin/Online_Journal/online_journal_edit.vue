        ...
        <div class="row mt-5" >
            ...
            <div class="col-lg-8 col-xs-12">
                <form @submit.prevent="submitOnline_Journal">                        
                    หัวเรื่อง
                    <input type="text" v-model="online_journalE.oj_title" class="form-control" required>
                    <br>
                    รายระเอียด
                    <textarea v-model="online_journalE.oj_detail" class="form-control" rows="6" ></textarea>
                    <br>
                    Description
