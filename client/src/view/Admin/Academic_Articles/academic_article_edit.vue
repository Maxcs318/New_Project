<template>
    <div class="container ">
        <center><h4>Edit Academic Article</h4></center>
        <div class="row mt-5" v-if="thisAcademic_Article && the_user">
            <div class="col-lg-2 col-xs-12"></div>
            <div class="col-lg-8 col-xs-12">
                <img v-if="url"  :src="url" width="100%"/>
                <img v-else :src="getImgUrl(thisAcademic_Article.aa_image)" width="100%">
                <br><br>
                ...
                <form @submit.prevent="submitArticle">                        
                    ...
                    หัวเรื่อง
                    <input type="text" v-model="academic_articleE.aa_title" class="form-control" required>
                    <br>
                    ประเภทของบทความ
                    <select v-model="academic_articleE.aa_category" class="form-control" required>
                        <option v-for="aac in academic_article_category" :value="aac.aac_id" >
                            {{ aac.aac_title }}
                        </option>
                    </select>
                    <br>
                    รายระเอียด
                    <textarea v-model="academic_articleE.aa_detail" class="form-control" rows="6" ></textarea>
                    <br>
    ...
    computed : {
        ...
        thisAcademic_Article(){
            ...
            for(var i=0; i<academic_articleAll.length; i++){
                if(academic_articleAll[i].aa_id == this.$route.params.AcademicArticleID){
