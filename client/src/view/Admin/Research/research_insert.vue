    ...
    <div class="container" v-if="the_user">
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                <h4><center>Research Insert</center></h4>   
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-6 col-xs-12">
                <form @submit.prevent="submitResearch">
                    Title
                    <input type="text" v-model="research.r_title" class="form-control" required>
                    <br>
                    Title Alternative
                    ...
                    <br>
                    Description
                    <textarea v-model="research.r_description" class="form-control" rows="6" ></textarea>
                    <br>
                    Publisher
                    <textarea v-model="research.r_publisher" class="form-control" rows="3" ></textarea>
                    <br>
                    Created Date
                    <input type="text" v-model="research.r_createddate" class="form-control" required>
                    <br>
                    Modified Date
                    ...
                    <br>
                    Format
                    <input type="text" v-model="research.r_format" class="form-control" required>
                    <br>
                    Source
                    <input type="text" v-model="research.r_source" class="form-control" required>
                    <br>
                    Language
                    <input type="text" v-model="research.r_language" class="form-control" required>
                    <br>
                    Rights
