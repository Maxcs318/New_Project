<template>
  <div class="container" v-if="the_user">
    <h3 class="header">
      <center>List Award Type</center>
    </h3>
    <div class="row">
      <div class="col-lg-9 col-xs-12"></div>
      <div class="col-lg-3 col-xs-12">
        <button class="form-control btn-primary" @click="addaward_type">Add Award type</button>
        <br />
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12 col-md-12">
        <table style="width:100%">
          ...
          <tr v-for="(type,index) in Award_type" :key="index">
            ...
            <td>
              <button class="form-control btn-warning" @click="editAward_type(type.at_id)">Edit</button>
            </td>
            <td>
              <button class="form-control btn-danger" @click="deleteAward_type(type.at_id)">Delete</button>
            </td>
          </tr>
        </table>
      </div>
