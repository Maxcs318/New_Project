<template>
    <div class="container" v-if="the_user && thisAward_type">
        <h3><center> Add Award Type </center></h3>
        <div class="row">
            <div class="col-lg-3 col-xs-12"></div>
            <div class="col-lg-6 col-xs-12">
                <form @submit.prevent="submitAward_type">
                    Award type Name
                    <input type="text" class="form-control" v-model="award_type.at_title" required> <br>
                    Detail
                    <textarea v-model="award_type.at_detail" class="form-control" rows="6" ></textarea> <br>
                    <div class="row">
                        <div class="col-lg-6">
                        </div>
                        <div class="col-lg-6">
