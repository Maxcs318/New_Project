<template>
    <div class="container" v-if="the_user">
        <h3><center> Add Award Year </center></h3>
        <div class="row">
            <div class="col-lg-3 col-xs-12"></div>
            <div class="col-lg-6 col-xs-12">
                <form @submit.prevent="submitAward_year">
                    Award year 
                    <input type="text" class="form-control" v-model="award_year.ay_title" required> <br>
                    Detail
                    <textarea v-model="award_year.ay_detail" class="form-control" rows="6" ></textarea> <br>
                    <div class="row">
                        <div class="col-lg-6">
                        </div>
                        <div class="col-lg-6">
