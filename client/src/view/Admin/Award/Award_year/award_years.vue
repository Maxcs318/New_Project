<template>
    <div class="container" v-if="the_user">
        <h3><center> List Award Year </center></h3>
        <div class="row">
            <div class="col-lg-9 col-xs-12"></div>
            <div class="col-lg-3 col-xs-12">
                <button class="form-control btn-primary" @click="addaward_year">Add Award Year</button> <br>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <table style="width:100%" >
                    <tr style="width:100%">
                        ...
                        <th style="width:35%">Award Year Name</th>
                    ...
                    <tr v-for="(Year,index) in Award_years" :key="index" >
                        ...
                        <td> <button class="form-control btn-warning" @click="editAward_year(Year.ay_id)">Edit</button> </td>
                        <td> <button class="form-control btn-danger"  @click="deleteAward_year(Year.ay_id)">Delete</button> </td>
                    </tr>
                </table>
            </div>
        </div>
...
export default {
    methods:{
        ...
        editAward_year(thisaward_year){
            this.$router.push({name:'editaward_year',params:{Award_yearID:thisaward_year}});
        },
