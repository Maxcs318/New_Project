<template>
    <div class="container">
        <center><h4>Edit Gallery</h4></center>
        <div class="row" v-if="thisGallery">
            <div class="col-lg-3 col-xs-12"></div>
            <div class="col-lg-6 col-xs-12">
                <img v-if="url"  :src="url" width="100%"/>
                <img v-else :src="getImgUrl(thisGallery.g_image)" width="100%">
                <br><br>
                ...
                <form @submit.prevent="submitGallery">                        
                    ...
                    ชื่อ ภาพกิจกรรม
                    <input type="text" v-model="galleryE.g_name" class="form-control" required>
                    <br>
                    รายระเอียด
                    <textarea v-model="galleryE.g_description" class="form-control" rows="5" ></textarea>
                    <br>
