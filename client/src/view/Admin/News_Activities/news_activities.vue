<template>
    <div class="container" v-if="the_user">
        <h4 class=" ">ข่าวสาร & กิจกรรม ( ลำดับจาก ล่าสุด -> เก่า )</h4> <br>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                <table style="width:100%" >
                    ...
                    <tr v-for="(news,index) in the_news.slice().reverse().slice((page*data_in_page),(page+1)*data_in_page)" :key="index">
                        <td>{{news.n_id}}</td>
